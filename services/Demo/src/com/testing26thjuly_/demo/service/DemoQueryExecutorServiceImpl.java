...
@Service
public class DemoQueryExecutorServiceImpl implements DemoQueryExecutorService {
	private static final Logger LOGGER = LoggerFactory.getLogger(DemoQueryExecutorServiceImpl.class);

	@Autowired
	@Qualifier("DemoWMQueryExecutor")

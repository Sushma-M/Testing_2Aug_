...
import com.testing26thjuly_.demo.Table11;
import com.testing26thjuly_.demo.service.Table10Service;
import com.testing26thjuly_.demo.service.Table11Service;
 ...
 * @see Table11
 */
@RestController("Demo.Table11Controller")
@RequestMapping("/Demo/Table11")
...
public class Table11Controller {
    ...
    @RequestMapping(value = "/{id:.+}/table10s", method = RequestMethod.GET)
    @ApiOperation(value = "Gets the table10s instance associated with the given id.")
    public Page<Table10> findAssociatedTable10s(Pageable pageable, @PathVariable("id") Integer id) {
        LOGGER.debug("Fetching all associated table10s");
        return table10Service.findAssociatedValues(id, "table11", "id", pageable);
    }

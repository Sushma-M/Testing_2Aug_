...
/**
 * TypesSpacing generated by WaveMaker Studio.
 */
@Entity
@Table(name = "`Types_Spacing`", schema = "dbo")
public class TypesSpacing implements Serializable {
    ...
    @Column(name = "`Short Col`", nullable = false, scale = 0, precision = 4)
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof TypesSpacing)) return false;
        final TypesSpacing typesSpacing = (TypesSpacing) o;
        return Objects.equals(getId(), typesSpacing.getId());
    }

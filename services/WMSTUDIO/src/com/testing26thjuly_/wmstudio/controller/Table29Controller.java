...
import com.testing26thjuly_.wmstudio.service.Table29Service;
 ...
 * @see Table29
 */
@RestController("WMSTUDIO.Table29Controller")
@RequestMapping("/WMSTUDIO/Table29")
...
public class Table29Controller {
    ...
    @Autowired
    @Qualifier("WMSTUDIO.Table29Service")
    ...
    @RequestMapping(value = "/{id:.+}/table29sForColumn3", method = RequestMethod.GET)
    @ApiOperation(value = "Gets the table29sForColumn3 instance associated with the given id.")
    public Page<Table29> findAssociatedTable29sForColumn3(Pageable pageable, @PathVariable("id") Integer id) {
        LOGGER.debug("Fetching all associated table29sForColumn3");
        return table29Service.findAssociatedValues(id, "table29ByColumn3", "id", pageable);
    }
    ...
    public Table29 getTable29(@PathVariable(value = "id") Integer id) throws EntityNotFoundException {
    ...
    public Table29 editTable29(@PathVariable(value = "id") Integer id, @RequestBody Table29 table29) throws EntityNotFoundException {
        LOGGER.debug("Editing Table29 with id: {}", table29.getId());
        table29.setId(id);
    ...
    public boolean deleteTable29(@PathVariable(value = "id") Integer id) throws EntityNotFoundException {

...
import com.testing26thjuly_.testingdb123.Table7;
import com.testing26thjuly_.testingdb123.service.Table7Service;
 ...
 * @see Table7
 */
@RestController("TestingDb123.Table7Controller")
@RequestMapping("/TestingDb123/Table7")
...
public class Table7Controller {
    ...
    @Autowired
    @Qualifier("TestingDb123.Table7Service")
    ...
    public Table7 getTable7(@PathVariable(value = "id") Long id) throws EntityNotFoundException {
    ...
    public Table7 editTable7(@PathVariable(value = "id") Long id, @RequestBody Table7 table7) throws EntityNotFoundException {
    ...
    public boolean deleteTable7(@PathVariable(value = "id") Long id) throws EntityNotFoundException {

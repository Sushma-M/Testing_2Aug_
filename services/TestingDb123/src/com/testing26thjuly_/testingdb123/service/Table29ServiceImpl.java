 ...
 * @see Table29
 */
@Service("TestingDb123.Table29Service")
public class Table29ServiceImpl implements Table29Service {
    ...
    @Autowired
    @Qualifier("TestingDb123.Table29Dao")
    private WMGenericDao<Table29, String> wmGenericDao;

    public void setWMGenericDao(WMGenericDao<Table29, String> wmGenericDao) {
	...
	@Override
	public Table29 getById(String table29Id) throws EntityNotFoundException {
	...
	public Table29 update(Table29 table29) throws EntityNotFoundException {
        ...
        String table29Id = table29.getColumn2();
    ...
    @Transactional(value = "TestingDb123TransactionManager")
	@Override
	public Table29 delete(String table29Id) throws EntityNotFoundException {
    ...
    public Downloadable export(ExportType exportType, String query, Pageable pageable) {
        LOGGER.debug("exporting data in the service TestingDb123 for table Table29 to {} format", exportType);

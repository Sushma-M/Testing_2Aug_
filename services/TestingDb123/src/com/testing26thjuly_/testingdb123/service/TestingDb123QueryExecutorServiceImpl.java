...
@Service
public class TestingDb123QueryExecutorServiceImpl implements TestingDb123QueryExecutorService {
	private static final Logger LOGGER = LoggerFactory.getLogger(TestingDb123QueryExecutorServiceImpl.class);

	@Autowired
	@Qualifier("TestingDb123WMQueryExecutor")

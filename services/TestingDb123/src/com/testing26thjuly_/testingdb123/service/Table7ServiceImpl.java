 ...
 * @see Table7
 */
@Service("TestingDb123.Table7Service")
public class Table7ServiceImpl implements Table7Service {
    ...
    @Autowired
    @Qualifier("TestingDb123.Table7Dao")
    private WMGenericDao<Table7, Long> wmGenericDao;

    public void setWMGenericDao(WMGenericDao<Table7, Long> wmGenericDao) {
	...
	@Override
	public Table7 getById(Long table7Id) throws EntityNotFoundException {
    ...
    @Transactional(value = "TestingDb123TransactionManager")
	@Override
	public Table7 delete(Long table7Id) throws EntityNotFoundException {
    ...
    public Downloadable export(ExportType exportType, String query, Pageable pageable) {
        LOGGER.debug("exporting data in the service TestingDb123 for table Table7 to {} format", exportType);

 ...
 * @see Table12
 */
@Service("TestingDb123.Table12Service")
public class Table12ServiceImpl implements Table12Service {
    ...
    @Autowired
    @Qualifier("TestingDb123.Table12Dao")
    ...
    public Downloadable export(ExportType exportType, String query, Pageable pageable) {
        LOGGER.debug("exporting data in the service TestingDb123 for table Table12 to {} format", exportType);

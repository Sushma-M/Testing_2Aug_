...
public class QueryExecutionController {
    ...
    @RequestMapping(value = "/queries/SV_DeptCode", method = RequestMethod.GET)
    public Page<Object> executeSV_DeptCode(@RequestParam(value = "deptcode", required = false) java.lang.String deptcode, Pageable pageable) throws QueryParameterMismatchException {
        LOGGER.debug("Executing named query SV_DeptCode");
        Page<Object> result = queryService.executeSV_DeptCode(pageable, deptcode);
        LOGGER.debug("got the result of named query {}", result);
        return result;
    }

    @ApiOperation(value = "Process request to execute queries")
    @RequestMapping(value = "/queries/SV_Dept", method = RequestMethod.GET)
    public Page<Object> executeSV_Dept(Pageable pageable) {
        LOGGER.debug("Executing named query SV_Dept");
        Page<Object> result = queryService.executeSV_Dept(pageable);
        LOGGER.debug("got the result of named query {}", result);
        return result;
    }

    @ApiOperation(value = "Process request to execute queries")
    @RequestMapping(value = "/queries/SV_Employee", method = RequestMethod.GET)
    public Page<Object> executeSV_Employee(Pageable pageable) {
        LOGGER.debug("Executing named query SV_Employee");
        Page<Object> result = queryService.executeSV_Employee(pageable);
        LOGGER.debug("got the result of named query {}", result);
        return result;
    }

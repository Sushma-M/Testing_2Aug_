 ...
 * @see Table8
 */
@Service("CompositesTest.Table8Service")
public class Table8ServiceImpl implements Table8Service {
    ...
    @Autowired
    @Qualifier("CompositesTest.Table8Dao")
    ...
    public Downloadable export(ExportType exportType, String query, Pageable pageable) {
        LOGGER.debug("exporting data in the service CompositesTest for table Table8 to {} format", exportType);

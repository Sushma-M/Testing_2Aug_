...
import com.testing26thjuly_.compositestest.Table1;
 ...
 * @see Table1
 */
@Service("CompositesTest.Table1Service")
public class Table1ServiceImpl implements Table1Service {
    ...
    @Autowired
    @Qualifier("CompositesTest.Table1Dao")
    ...
    public Downloadable export(ExportType exportType, String query, Pageable pageable) {
        LOGGER.debug("exporting data in the service CompositesTest for table Table1 to {} format", exportType);

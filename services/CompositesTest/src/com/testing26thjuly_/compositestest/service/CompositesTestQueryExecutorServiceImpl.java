...
@Service
public class CompositesTestQueryExecutorServiceImpl implements CompositesTestQueryExecutorService {
	private static final Logger LOGGER = LoggerFactory.getLogger(CompositesTestQueryExecutorServiceImpl.class);

	@Autowired
	@Qualifier("CompositesTestWMQueryExecutor")
